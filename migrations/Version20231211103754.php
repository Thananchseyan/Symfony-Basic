 ...
 */
final class Version20231211103754 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD release_year INT NOT NULL, ADD description VARCHAR(255) DEFAULT NULL, ADD image_path VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie DROP release_year, DROP description, DROP image_path');
    }
}
